	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(ev)
				...
				keymap.set("n", "gD", vim.lsp.buf.declaration, opts) -- unchanged
				...
				keymap.set({ "n", "v" }, "<leader>ca", vim.lsp.buf.code_action, opts) -- unchanged
				opts.desc = "Smart rename"
				keymap.set("n", "<leader>rn", vim.lsp.buf.rename, opts) -- unchanged
