...
$env.config = {
    ...
    display_errors: {
        exit_code: false # assume the e xternal command prints an error message
    ...
    completions: {
        ...
        algorithm: "prefix" #"fuzzy"    # prefix or fuzzy
        sort: "smart" # "smart" (alphabetical for prefix matching, fuzzy score for fuzzy matching) or "alphabetical"
        external: {
            enable: true # set to false to prevent nushell looking into $env.PATH to find more suggestions, `false` recommended for WSL users as this look up may be very slow
            max_results: 100 # setting it lower can improve completion performance at the cost of omitting some options
            completer: $carapace_completer #null #carapace_completer # null # check 'carapace_completer' above as an example
        }
    ...
    keybindings: [
        ...
        #{
        #    name: custom_normal_mode
        #    modifier: alt
        #    keycode: char_k
        #    mode: [vi_insert]
        #    event: { send: vi_normal }
        #}
